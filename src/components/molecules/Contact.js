    ...
    return(
        <div id="contact" className="contact">
            ...
            <div>
                ...
                <a href="https://www.linkedin.com/in/trishabernice" rel="noopener noreferrer" target="_blank"><FaLinkedin size={35} className="icons"/></a>
                ...
                <a href="mailto:trisha.bernice@yahoo.com" rel="noopener noreferrer" target="_blank"><FaEnvelopeSquare size={35} className="icons"/></a>
            </div>
